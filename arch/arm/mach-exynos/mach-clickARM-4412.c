...
static int fan54_chr_init(void)
{
	...
	gpio_request(EXYNOS4212_GPM3(0), "FAN54_INT");
	s3c_gpio_cfgpin(EXYNOS4212_GPM3(0), S3C_GPIO_SFN(0xf));
...
struct tsc2007_platform_data tsc2007_info = {
	...
	.poll_delay	= 5,  //delay (in ms) after pen-down event before polling starts 
